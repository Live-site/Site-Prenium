...
send.addEventListener("click", () => {
	...
	fetch(API)
		...
		.then((data) => {
			...
			dateTextNow.innerHTML = data["list"][0]["dt_txt"];
			dateTextTwo.innerHTML = data["list"][1]["dt_txt"];
			dateTextThree.innerHTML = data["list"][2]["dt_txt"];
			dateTextFour.innerHTML = data["list"][3]["dt_txt"];
